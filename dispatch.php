  ...
  float: right;
	...
	<div class="main-wrapper">
		...
		<div class="content container-fluid">
            ...
            <a style="color: red; font-size:20px;">Entry Form :- <span style="color: blue; text-align: left; font-size:20px;">Dispatch DAAK<span></a><br><br>
...
document.getElementById("opt").selectedIndex = 0;
				...
				<script>
					...
					$('select[name="classified"]').attr('disabled',this.value!="Yes")
							...
							<div>	
								<div class="form-group">
									<label style="color:blue; font-size:20px;" class="control-label">Receipt Details</label>
								</div><br><br>
									<div class="form-group">
